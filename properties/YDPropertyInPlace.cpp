#include "YDPropertyInPlace.h"

#include <QDoubleSpinBox>

#include "modules/YDModule.h"

YDPropertyInPlace::YDPropertyInPlace(YDModule *m, double min,
                                                       double max,
                                                       YDProperty *parent)
...
QWidget *YDPropertyInPlace::editor(QWidget *parent) {
...
void YDPropertyInPlace::updateEditor(YDModule *m) {
  m_widget->setValue(get(m));
}

void YDPropertyInPlace::updateWidget(YDModule *m) {
