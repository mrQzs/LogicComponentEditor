#ifndef YDPROPERTYIOVAR_H
#define YDPROPERTYIOVAR_H
...
class YDPropertyIOVar : public YDProperty {
 public:
  YDPropertyIOVar(YDProperty *parent = nullptr);
