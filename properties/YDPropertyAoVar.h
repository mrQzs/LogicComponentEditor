#ifndef YDPROPERTYAOVAR_H
#define YDPROPERTYAOVAR_H
...
class YDPropertyAoVar : public YDProperty {
 public:
  YDPropertyAoVar(YDProperty *parent = nullptr);
