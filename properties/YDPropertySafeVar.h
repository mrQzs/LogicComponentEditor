#ifndef YDPROPERTYSAFEVAR_H
#define YDPROPERTYSAFEVAR_H

#include "YDProperty.h"

class QComboBox;

class YDPropertySafeVar : public YDProperty {
 public:
  YDPropertySafeVar(YDProperty *parent = nullptr);
