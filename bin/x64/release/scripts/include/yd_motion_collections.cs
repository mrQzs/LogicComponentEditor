...
namespace YudaoMotionCollections
{
	...
	public static class YDROVariableCollection
	{
		...
		public static YDROVariable<Boolean> AX轴_原点信号标志 = new YDROVariable<Boolean>(600001001000010, "AX轴_原点信号标志", true, false);
		public static YDROVariable<Boolean> AX轴_回零状态标志 = new YDROVariable<Boolean>(600001001000011, "AX轴_回零状态标志", true, false);
		public static YDROVariable<Boolean> AX轴_驱动使能标志 = new YDROVariable<Boolean>(600001001000012, "AX轴_驱动使能标志", true, false);
		public static YDROVariable<UInt32> AX轴_运动模式 = new YDROVariable<UInt32>(600001001000020, "AX轴_运动模式", 60000, 0);
		...
		public static YDROVariable<Boolean> AY轴_原点信号标志 = new YDROVariable<Boolean>(600001002000010, "AY轴_原点信号标志", true, false);
		public static YDROVariable<Boolean> AY轴_回零状态标志 = new YDROVariable<Boolean>(600001002000011, "AY轴_回零状态标志", true, false);
		public static YDROVariable<Boolean> AY轴_驱动使能标志 = new YDROVariable<Boolean>(600001002000012, "AY轴_驱动使能标志", true, false);
		public static YDROVariable<UInt32> AY轴_运动模式 = new YDROVariable<UInt32>(600001002000020, "AY轴_运动模式", 60000, 0);
		...
		public static YDROVariable<Boolean> AZ轴_原点信号标志 = new YDROVariable<Boolean>(600001003000010, "AZ轴_原点信号标志", true, false);
		public static YDROVariable<Boolean> AZ轴_回零状态标志 = new YDROVariable<Boolean>(600001003000011, "AZ轴_回零状态标志", true, false);
		public static YDROVariable<Boolean> AZ轴_驱动使能标志 = new YDROVariable<Boolean>(600001003000012, "AZ轴_驱动使能标志", true, false);
		public static YDROVariable<UInt32> AZ轴_运动模式 = new YDROVariable<UInt32>(600001003000020, "AZ轴_运动模式", 60000, 0);
		...
		public static YDROVariable<Boolean> A旋转轴_原点信号标志 = new YDROVariable<Boolean>(600001004000010, "A旋转轴_原点信号标志", true, false);
		public static YDROVariable<Boolean> A旋转轴_回零状态标志 = new YDROVariable<Boolean>(600001004000011, "A旋转轴_回零状态标志", true, false);
		public static YDROVariable<Boolean> A旋转轴_驱动使能标志 = new YDROVariable<Boolean>(600001004000012, "A旋转轴_驱动使能标志", true, false);
		public static YDROVariable<UInt32> A旋转轴_运动模式 = new YDROVariable<UInt32>(600001004000020, "A旋转轴_运动模式", 60000, 0);
	...
	public static class YDRWVariableCollection
	{
		...
		public static YDRWVariable<Boolean> 气油缸1前进控制 = new YDRWVariable<Boolean>(200001000000001, "气油缸1前进控制", true, false);
		public static YDRWVariable<Boolean> 气油缸1后退控制 = new YDRWVariable<Boolean>(200001000000002, "气油缸1后退控制", true, false);
		public static YDRWVariable<Boolean> 气油缸2上升下降控制 = new YDRWVariable<Boolean>(200001000000003, "气油缸2上升下降控制", true, false);
		public static YDRWVariable<Boolean> 箱内照明 = new YDRWVariable<Boolean>(200001000000004, "箱内照明", true, false);
		public static YDRWVariable<Boolean> A工位照明 = new YDRWVariable<Boolean>(200001000000005, "A工位照明", true, false);
		public static YDRWVariable<Boolean> B工位照明 = new YDRWVariable<Boolean>(200001000000006, "B工位照明", true, false);
	}
