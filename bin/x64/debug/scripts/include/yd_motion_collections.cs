...
namespace YudaoMotionCollections
{
	...
	{
		// 导出的变量实例
		public static YDROVariable<Byte> 工作状态 = new YDROVariable<Byte>(1, "工作状态", 1000, 0);
		public static YDROVariable<Byte> 控制模式 = new YDROVariable<Byte>(2, "控制模式", 1000, 0);
	...
	{
		// 导出的变量实例
		public static YDRWVariable<Boolean> test = new YDRWVariable<Boolean>(9110001000000001, "test", true, false);
	}
