...
constexpr Byte YD_API_VARIABLE_TYPE_GLOBAL = 91;		// 全局变量，读/写
constexpr Byte YD_API_VARIABLE_TYPE_RECIPE = 92;		// 配方变量，读/写
constexpr Byte YD_API_VARIABLE_TYPE_LOCAL = 93;			// 临时变量，读/写
...
// 轴回零状态
constexpr uint8 YD_API_AXIS_HOME_MOVE_NOT_EXECUTED = 0;	// 未回零
constexpr uint8 YD_API_AXIS_HOME_MOVE_IN_PROCESSING = 1;// 回零中
constexpr uint8 YD_API_AXIS_HOME_MOVE_EXECUTED = 2;		// 已回零
