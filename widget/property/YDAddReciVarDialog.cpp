...
YDAddReciVarDialog::YDAddReciVarDialog(QWidget *parent)
    : YDDialog{parent},
  ...
  m_okBtn->setText(YDAddReciVarDialog::tr("确认"));
  m_cancelBtn->setText(YDAddReciVarDialog::tr("取消"));
  ...
  connect(m_okBtn, &QPushButton::clicked, this,
          &YDAddReciVarDialog::slotOkBtnClicked);

  connect(m_cancelBtn, &QPushButton::clicked, this,
          &YDAddReciVarDialog::slotCancelBtnClicked);

  connect(m_typeCombo, &QComboBox::currentIndexChanged, this,
          &YDAddReciVarDialog::slotTypeChanged);
...
void YDAddReciVarDialog::slotOkBtnClicked() {
  if (m_nameEdit->text().isEmpty()) {
    QMessageBox::warning(this, YDAddReciVarDialog::tr("错误"),
                         YDAddReciVarDialog::tr("名字不能为空!"));
    return;
  }
...
void YDAddReciVarDialog::slotCancelBtnClicked() { reject(); }

void YDAddReciVarDialog::slotTypeChanged(int index) {
  m_boolLab->hide();
  m_boolBox->hide();
  m_axisLab->hide();
  m_axisBtn->hide();
...
void YDAddReciVarDialog::slotAxisBtnClicked(bool) {
  ...
  connect(m_varDlg, &QDialog::finished, this,
          &YDAddReciVarDialog::slotVarDialogFinished);
...
void YDAddReciVarDialog::slotVarDialogFinished() {
