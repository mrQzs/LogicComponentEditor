#ifndef YDADDTEMPVARDIALOG_H
#define YDADDTEMPVARDIALOG_H
...
class YDAddTempVarDialog : public YDDialog {
  Q_OBJECT
 public:
  YDAddTempVarDialog(QWidget *parent = nullptr);
